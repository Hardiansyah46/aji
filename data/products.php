...
$products = [
    ...
    [
        ...
        'full_desc' => '<p>
          ...
          <p>
            Terbuat dari bahan berkualitas yang nyaman dipakai, dilengkapi saku
            depan dengan kancing, resleting kuat, serta detail emblem di lengan
            untuk menambah kesan modis.
          </p>

          <h4>Mengapa Memilih Jaket Ini?</h4>
          <ul>
            <li>
              <strong>Desain Keren:</strong> Model military yang tidak lekang
              oleh waktu.
            </li>
            <li>
              <strong>Bahan Nyaman:</strong> Lembut di kulit dan cocok dipakai
              seharian.
            </li>
            <li>
              <strong>Detail Menarik:</strong> Emblem di lengan dan kancing
              stylish.
            </li>
          </ul>

          <h4>Tips Padu Padan Jaket Military</h4>
          <ul>
            <li>
              <strong>Casual Look:</strong> Padukan dengan kaos polos dan jeans.
            </li>
            <li>
              <strong>Traveling Style:</strong> Gunakan bersama cargo pants dan
              sneakers.
            </li>
            <li>
              <strong>Streetwear:</strong> Tambahkan topi dan sepatu boots.
            </li>
          </ul>

          <p>
            Dengan jaket ini, kamu akan tampil lebih percaya diri di setiap
            kesempatan.
          </p>

          <h4>Rekomendasi Jaket Military Pria</h4>
          <p>
    ...
    [
        ...
        'full_desc' => '<p>
          ...
          <p>
            Sneakers adalah pilihan sempurna untuk menemani aktivitas
            harian—baik saat hangout, jalan-jalan, maupun acara santai di
            kantor. Berikut alasan mengapa sneakers adalah investasi fashion
            yang tak boleh Anda lewatkan:
          </p>

          <h4>Mengapa Memilih Sneakers?</h4>
          <ul>
            <li>
              <strong>Kenyamanan Maksimal:</strong> Didesain dengan sol empuk
              dan bahan ringan, sneakers cocok untuk pemakaian seharian tanpa
              rasa lelah.
            </li>
            <li>
              <strong>Fleksibilitas Gaya:</strong> Cocok dipadukan dengan jeans,
              chino, jogger, bahkan celana pendek.
            </li>
            <li>
              <strong>Desain Variatif:</strong> Mulai dari warna monokrom yang
              kalem hingga model penuh warna yang ekspresif—ada untuk semua
              selera.
            </li>
          </ul>

          <h4>Tips Memilih Sepatu Sneakers yang Tepat</h4>
          <ul>
            <li>
              <strong>Ukuran Pas:</strong> Hindari sneakers yang terlalu sempit
              atau longgar agar tetap nyaman dipakai seharian.
            </li>
            <li>
              <strong>Bahan Berkualitas:</strong> Pastikan bahannya tahan lama
              dan tidak mudah rusak meskipun sering digunakan.
            </li>
            <li>
              <strong>Sesuaikan Kebutuhan:</strong> Untuk berjalan jauh, pilih
              sol empuk. Untuk tampilan modis, pilih desain yang unik dan
              menarik.
            </li>
          </ul>

          <p>
            Dengan sepasang sneakers yang tepat, Anda akan tampil stylish dan
            tetap merasa nyaman sepanjang hari.
          </p>

          <h4>Rekomendasi Produk Sneakers Pria</h4>
          <p>
    ...
    [
        ...
        'full_desc' => '<p>
          ...
          <ul>
            <li><strong>Merek:</strong> WIN</li>
            <li><strong>Bahan:</strong> Plastik & Mika</li>
            <li><strong>Isi Paket:</strong></li>
            <ul>
              <li>✔ Reflektor / Lampu depan (tanpa bohlam & fitting)</li>
              <li>✔ Stiker resmi KOBARSPAREPART</li>
            </ul>
          </ul>

          <h4>Catatan Penting</h4>
          <ul>
            <li>❌ Tidak termasuk fitting lampu/sen</li>
            <li>❌ Tidak termasuk bohlam utama/sen</li>
            <li>
              ⚠️ Pastikan cocok untuk <strong>NMAX New / Facelift</strong>
            </li>
          </ul>

          <h4>Rekomendasi Pembelian</h4>
          <p>
